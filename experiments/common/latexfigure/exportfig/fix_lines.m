...
DashedLinesStd = ['4' '1.5'];

DashedLines = DashedLinesStd;
...
new_style = {'/dom { dpi2point 1 currentlinewidth 0.08 mul add mul mul } bdef',... % Dot length macro based on line width
             ...
             '/DO { [0.5 dom 0.6 dom] 0 setdash 0 setlinecap } bdef',... % Dotted lines
             '/DA { [' DashedLines(1) ' dam ' DashedLines(2) ' dam] 0 setdash 0 setlinecap } bdef',... % Dashed lines
