...
far1 = far1 ./ size(negs,1) .* 100;
frr1 = frr1 ./ (size(corrects,1) - num_outliers) .* 100;
...
% [corrects2, negs2] = tester(distances_hamming, imp_distances_hamming, thresholds, limits, num_per_sample);
...
legend({'Uniform LBP', 'Fourier LBP   ', 'EER'});
