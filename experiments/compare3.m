...
legend({'Uniform LBP', 'SVM: Fourier LBP + Canonical LBP + MHD', 'Fourier LBP', 'MHD', 'Canonical LBP', 'Cluster', 'EER Line'});

scatter(far4, frr4, 25, colours(1,:), 'filled');
scatter(far6, frr6, 25, colours(2,:), 'filled');
scatter(far5, frr5, 25, colours(3,:), 'filled');
scatter(far, frr, 25, colours(4,:), 'filled');
scatter(far3, frr3, 25, colours(5,:), 'filled');
scatter(far2, frr2, 25, colours(6,:), 'filled');
